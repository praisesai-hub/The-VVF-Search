...
class MoshiEntityAdapterJvmTest {
    ...
    fun nestedAndOtherEntityAdapters_roundTripAllModels(): Unit {
        ...
        val cloud = CloudSyncItemEntity(
            ...
            remoteRevisionId = "revision-id",
            contentHash = "sha256-value",
            uploadSessionUri = "https://upload.example.test/session",
            etag = "etag-value",
        )
        ...
        val operation = VaultOperationEntity(
            ...
            sourceFileId = 99L,
            sourcePath = "/documents/secret.txt",
            encryptedFilePath = "/vault/ENC_secret.vvf",
            encryptedFileName = "ENC_secret.vvf",
            originalName = "secret.txt",
            category = "DOCUMENTS",
            sizeBytes = 128L,
            ivBase64 = "AQIDBA==",
        ...
        assertEquals(operation, roundTrip(operation, VaultOperationEntity::class.java))
    }
